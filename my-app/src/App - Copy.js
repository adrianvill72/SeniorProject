...
function App() {
  ...
  useEffect(() => {
    if (svgRef.current) {
      svgRef.current.setAttribute('xml:space', 'preserve');
    }
    ...
    ui.start('#firebaseui-auth-container', {
      ...
      signInSuccessUrl: 'https://www.google.com', // This is where should redirect if the sign in is successful.
      ...
      tosUrl: 'https://www.google.com', // URL to you terms and conditions.
  ...
  return (
      <>
        <div className="bg-primary pt-5 pb-0 position-relative">
          <figure
              className="m-0 position-absolute top-50 start-50 translate-middle w-100 h-100 opacity-1 overflow-hidden">
            <svg className="vh-100" enableBackground="new 0 0 628.7 371" version="1.1" viewBox="0 0 628.7 371"
        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            <div className="col-12">
              ...
              <h1 className="display-4 text-black mb-4 position-relative">Welcome back!</h1>

              <figure className="m-0 position-relative z-index-9">
                <svg className="col-sm-8 col-lg-4" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     viewBox="0 0 291.3 235.4" style={{enableBackground: "new 0 0 291.3 235.4"}}>
